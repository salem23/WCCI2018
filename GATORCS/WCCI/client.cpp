...
#define __DRIVER_CLASS__ SM_Driver     // put here the name of your driver class
#define __DRIVER_INCLUDE__ "SM_Driver.h" // put here the filename of your driver h\\eader
...
CarState cs(buf);
// fitest<<cs.getSpeedX()<< ","<<cs.getDamage()<<endl;//<<","<<targetSpeed <<endl;
	...
	unsigned long currentStep=0; 
        ...
        while(1)
        {
            ...
            if (select(socketDescriptor+1, &readSet, NULL, NULL, &timeVal))
            {
               ...
               //ששש cout << "Received: " << buf << endl;
#endif
//	fprintf(resultFile, "Received : %f\n", currentStep);
...
//fprintf(resultFile,"in: %f,%f,%f,%f,%f,%f,%f\n out:%f,%f,%f\n", cs.getTrack(9),fmax(cs.getTrack(8),cs.getTrack(10)),fmax(cs.getTrack(7),cs.getTrack(11)),cs.getAngle(),cs.getSpeedZ(),cs.getSpeedX(),cs.getSpeedY(),steer,acce,targetSpeed );            
//resultFile<<cs.getTrack(9)<<","<<fmax(cs.getTrack(8),cs.getTrack(10))<<","<<cs.getTrack(8)<<","<<cs.getTrack(10);
//fprintf(resultFile,"in: %f,%f,%f,%f\n out:%f,%f,%f\n", cs.getTrack(9),max(cs.getTrack(8),cs.getTrack(10)),max(cs.getTrack(7),cs.getTrack(11)),cs.getAngle(),cs.getSpeedZ(),cs.getSpeedX(),cs.getSpeedY() );
//fprintf(resultFile, "Time : %f\n", currentStep);
//fprintf(resultFile, buf,"\n");
}
