...
evaluation procedure; to this end, several different fitness functions are
studied in several experiments, along with several
...
% We don't deal with noise explicitly, we just reevaluate all cars
% every generation - JJ
\end{abstract}
\begin{IEEEkeywords}
